  ...
  <div class="col-sm ">
   ...
   <strong><h1>Registrarse</h1></strong> 
    ...
    <div class=" form-group  d-flex justify-center">
      <input v-model="form.name" type="text" class="form-control bg-stone-300" style="width: 60%;"  name="nombre" autocomplete="name" require placeholder="Nombre">
...
<div class="row">
  ...
  <div class="col-sm d-flex justify-center form-group ">
    ...
    <input v-model="form.password1" type="password" class="form-control  bg-stone-300" style="width: 60%;" autocomplete="off" name="contraseña" require placeholder="Contraseña">
  </div>
